...
class CanvasImage {
  ...
  public setImage = function (image) {
...
class ColorThief {
   ...
   *
   * */
  public getColor = function (sourceImage, quality = 10) {
   ...
   *
   */
  public getPalette = function (sourceImage, colorCount, quality) {
  ...
  public getColorFromUrl = function (imageUrl, callback, quality) {
  ...
  public getImageData = function (imageUrl, callback) {
  ...
  public getColorAsync = function (imageUrl, callback, quality) {
    const thief = this;
